<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('show_doctors_admin')}}">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('index')}}">
          ...
          <span class="menu-title">Add specializations</span>
        </a>
      </li>
      <li class="nav-item menu-items">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{url('showspecialization')}}">
          <span class="menu-icon">
            <i class="mdi mdi-file-document-box"></i>
          </span>
          <span class="menu-title">show specializations</span>
        </a>
      </li>
    </ul>
  </nav>
